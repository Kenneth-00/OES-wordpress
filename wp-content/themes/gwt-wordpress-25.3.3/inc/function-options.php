...
function govph_displayoptions( $options ){
  ...
  switch ($options) {
    ...
    case 'govph_logo':
      ...
      $addLogo = (!empty($option['govph_logo_enable']) == 1) ? '<img src="'.$logo_image.'" />' : 
      '<div id="textlogo-wrapper">
        ...
        <div id="textlogo-inner-wrapper">
          ...
          <div id="agency-name">'.!empty($option['govph_agency_name']).'</div>
          <div id="agency-tagline">'.!empty($option['govph_agency_tagline']).'</div>
        </div>
       </div>' ;
      echo $addLogo;
      break;
    ...
    case 'govph_slider_full':
      if (!empty($option['govph_slider_fullwidth']) == 'true') {
        $val = 'active';
        return $val;
      }
      break;
    case 'govph_slider_start':
      ...
      elseif (!empty($option['govph_slider_fullwidth']) != 'true' || is_active_sidebar('banner-section-1') || is_active_sidebar('banner-section-2')) {
        echo '<div class="row">';
      }
      break;
    ...
    case 'govph_banner_title_start':
      ...
      elseif (!empty($option['govph_slider_fullwidth']) != 'true') {
        echo '';
      }
      break;
